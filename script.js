const urlBase = "https://jsonplaceholder.typicode.com/posts"; //URL de la fake api
...
function postData() {
    ...
    fetch(urlBase, {
        ...
        .catch(error => console.log("Error al crear el posteo: ", error));
}
...
function deletePost(id) {
    ...
    .then(res => {
        if(res.ok){
            ...
            alert('Hubo un error al borrar el posteo');
        }
    })
